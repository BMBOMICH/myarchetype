// ═══════════════════════════════════════════════════════════════
// utils/breachDefense.ts — FULL UPDATED
// Covers: [36] #797 Ashley Madison-style extortion detection
// [36] Breach notification, credential exposure, ATO
// [36] HIBP integration, credential stuffing, data exfiltration
// ═══════════════════════════════════════════════════════════════
...
const[pc,ec]=await Promise.all([isPasswordCompromised(pw),checkEmailBreaches(email)]);const a=pc.compromised&&pc.count>1000?'force_reset':pc.compromised||ec.breached?'notify_user':'none';
...
// ─── [36] #797 Ashley Madison-style extortion detection ───────
...
// Additional Ashley Madison-specific patterns
...
// ─── [36] Data exfiltration detection ────────────────────────
...
// ─── [36] Breach notification compliance ─────────────────────
...
// ─── [36] Credential exposure monitoring ─────────────────────
...
// AUTO-INJECTED: Detector #796 [36] Post-breach user notification and forced password rotation
// Severity: high
...
// Pattern anchors: breachNotify, forcedPasswordReset, breachResponse
