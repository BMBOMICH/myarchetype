...
export interface Translations {
  ...
  /** Full sentence including CTA — used as accessibility label */
  alreadyHaveAccount:     string;
  /** Question only, without CTA — used in split footer link */
...
const translations: Record<Language, Translations> = {
  ...
  // ── Placeholder languages (filled from English below) ────────────────────────
  es: { ...({} as Translations) },
  fr: { ...({} as Translations) },
  de: { ...({} as Translations) },
  ar: { ...({} as Translations) },
...
// Fill placeholder languages with English as fallback
(['es', 'fr', 'de', 'ar', 'pt', 'zh'] as Language[]).forEach((lang) => {
...
/** Returns the full translation object for a given language, falling back to English */
export const getTranslation = (language: Language): Translations =>
  translations[language] ?? translations.en;

/** Default language — Azerbaijani per app requirements */
export const DEFAULT_LANGUAGE: Language = 'az';

/** All supported language codes */
export const SUPPORTED_LANGUAGES: Language[] = [
  'az', 'tr', 'en', 'ru', 'es', 'fr', 'de', 'ar', 'pt', 'zh',
];