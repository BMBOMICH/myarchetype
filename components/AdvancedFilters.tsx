      ...
      <View style={styles.optionsGrid}>
        {options.map((option) => (
          <TouchableOpacity
            ...
            style={[
              styles.optionChip,
              selected.includes(option) && styles.optionChipActive,
            ]}
          ...
          >
            <Text
              style={[
                ...
                selected.includes(option) && styles.optionChipTextActive,
              ]}
            >
              {option}
            </Text>
      ...
      <View style={styles.container}>
        ...
        <ScrollView style={styles.scrollContent}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.rangeRow}>
              <TextInput
                ...
                onChangeText={(t) =>
                  setFilters({ ...filters, minAge: t.replace(/[^0-9]/g, '') })
                }
              ...
              <TextInput
                ...
                onChangeText={(t) =>
                  setFilters({ ...filters, maxAge: t.replace(/[^0-9]/g, '') })
                }
                keyboardType="number-pad"
                maxLength={2}
                placeholder="99"
              ...
              <View style={styles.distanceOptions}>
                {['25', '50', '100', '250', '500', '9999'].map((dist) => (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.distanceChip,
                      filters.maxDistance === dist && styles.distanceChipActive,
                    ]}
                  ...
                  >
                    <Text
                      style={[
                        ...
                        filters.maxDistance === dist && styles.distanceChipTextActive,
                      ]}
                    >
          ...
          <View style={styles.section}>
            ...
            <View style={styles.rangeRow}>
              <TextInput
                ...
                onChangeText={(t) =>
                  setFilters({ ...filters, minHeight: t.replace(/[^0-9]/g, '') })
                }
                keyboardType="number-pad"
                maxLength={3}
                placeholder="Any"
              ...
              <TextInput
                ...
                onChangeText={(t) =>
                  setFilters({ ...filters, maxHeight: t.replace(/[^0-9]/g, '') })
                }
                keyboardType="number-pad"
                maxLength={3}
                placeholder="Any"
          ...
          {renderMultiSelect('Body Type', BODY_TYPES, filters.bodyTypes, (item) =>
            setFilters({
              ...filters,
              bodyTypes: toggleArrayItem(filters.bodyTypes, item),
            })
          )}
          ...
          {renderMultiSelect(
            'Religious Views',
            RELIGIOUS_OPTIONS,
            filters.religiousViews,
            (item) =>
              setFilters({
                ...filters,
                religiousViews: toggleArrayItem(filters.religiousViews, item),
              })
          )}
          ...
          {renderMultiSelect('Lifestyle', LIFESTYLE_OPTIONS, filters.lifestyles, (item) =>
            setFilters({
              ...filters,
              lifestyles: toggleArrayItem(filters.lifestyles, item),
            })
          )}
          ...
          {renderMultiSelect(
            ...
            (item) =>
              setFilters({
                ...filters,
                relationshipGoals: toggleArrayItem(filters.relationshipGoals, item),
              })
          )}
          ...
          {renderMultiSelect(
            'Personality Type',
            PERSONALITY_OPTIONS,
            filters.personalityTypes,
            (item) =>
              setFilters({
                ...filters,
                personalityTypes: toggleArrayItem(filters.personalityTypes, item),
              })
          )}
          ...
          <View style={styles.section}>
            ...
            >
              ...
              <View
                style={[
                  styles.toggleBox,
                  filters.verifiedOnly && styles.toggleBoxActive,
                ]}
              >
            ...
            >
              ...
              <View
                style={[styles.toggleBox, filters.hasPhotos && styles.toggleBoxActive]}
              >
