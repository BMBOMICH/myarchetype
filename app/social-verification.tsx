...
export default function SocialVerificationScreen() {
  ...
  const handleLinkInstagram = async () => {
    ...
    const result = await linkInstagram(instagramInput);
    setLinking(null);
  ...
  const handleLinkLinkedIn = async () => {
    ...
    setLinking('linkedin');
    const result = await linkLinkedIn(linkedinInput);
    setLinking(null);
  ...
  const handleUnlink = async (platform: 'instagram' | 'linkedin' | 'spotify') => {
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.trustCard}>
        ...
        <Text style={styles.trustSubtext}>
          Link social media to boost your trust score
        </Text>
      </View>
      ...
      <View style={styles.infoCard}>
        ...
        <Text style={styles.infoText}>
          ...
          • Matches can see your real social life
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        {socialLinks.linkedin ? (
          <View style={styles.linkedCard}>
            <TouchableOpacity
              style={styles.linkedInfo}
              onPress={() => openLinkedInProfile(socialLinks.linkedin!.profileUrl)}
            >
              <Text style={styles.linkedUsername}>Profile Linked</Text>
              <Text style={styles.linkedDate}>
                Linked {formatSocialLinkDate(socialLinks.linkedin.linkedAt)}
              </Text>
              <Text style={styles.tapToView}>Tap to view profile →</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.unlinkButton}
              onPress={() => handleUnlink('linkedin')}
            >
              <Text style={styles.unlinkButtonText}>Unlink</Text>
            </TouchableOpacity>
          </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.comingSoonCard}>
          <Text style={styles.comingSoonText}>
            Connect Spotify to show your music taste and find matches with similar music preferences!
          </Text>
        </View>
      </View>
      ...
      <View style={styles.privacyNote}>
        ...
        <Text style={styles.privacyText}>
          Your social links are only visible to your matches. We never post on your behalf.
        </Text>
      </View>
    </ScrollView>
  );
