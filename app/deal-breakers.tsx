  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <Text style={styles.subtitle}>
        Set hard limits. Profiles that don't match these won't be shown.
      </Text>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.toggleRow}>
          <Text style={styles.toggleLabel}>Must be verified</Text>
          <Switch
            value={dealBreakers.mustHaveVerified}
            onValueChange={(v) => updateBreaker('mustHaveVerified', v)}
        ...
        <View style={styles.toggleRow}>
          <Text style={styles.toggleLabel}>Must have bio</Text>
          <Switch
            value={dealBreakers.mustHaveBio}
            onValueChange={(v) => updateBreaker('mustHaveBio', v)}
            trackColor={{ false: '#555', true: '#53a8b6' }}
            thumbColor="#fff"
          />
        </View>
        ...
        <View style={styles.toggleRow}>
          <Text style={styles.toggleLabel}>Must have 3+ photos</Text>
          <Switch
            value={dealBreakers.mustHaveMultiplePhotos}
            onValueChange={(v) => updateBreaker('mustHaveMultiplePhotos', v)}
            trackColor={{ false: '#555', true: '#53a8b6' }}
            thumbColor="#fff"
          />
        </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.rangeRow}>
          <TextInput
            ...
            value={dealBreakers.minAge?.toString() || ''}
            onChangeText={(t) => updateBreaker('minAge', t ? parseInt(t) : null)}
          ...
          <TextInput
            ...
            placeholder="Max"
            placeholderTextColor="#666"
            value={dealBreakers.maxAge?.toString() || ''}
            onChangeText={(t) => updateBreaker('maxAge', t ? parseInt(t) : null)}
            keyboardType="number-pad"
            maxLength={2}
          />
        </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.rangeRow}>
          <TextInput
            ...
            placeholder="Min"
            placeholderTextColor="#666"
            value={dealBreakers.minHeight?.toString() || ''}
            onChangeText={(t) => updateBreaker('minHeight', t ? parseInt(t) : null)}
            keyboardType="number-pad"
            maxLength={3}
          />
          <Text style={styles.rangeDash}>to</Text>
          <TextInput
            ...
            placeholder="Max"
            placeholderTextColor="#666"
            value={dealBreakers.maxHeight?.toString() || ''}
            onChangeText={(t) => updateBreaker('maxHeight', t ? parseInt(t) : null)}
            keyboardType="number-pad"
            maxLength={3}
          />
        </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.toggleRow}>
          <Text style={styles.toggleLabel}>No smoking</Text>
          <Switch
            value={dealBreakers.noSmoking}
            onValueChange={(v) => updateBreaker('noSmoking', v)}
            trackColor={{ false: '#555', true: '#53a8b6' }}
            thumbColor="#fff"
          />
        </View>
        ...
        <View style={styles.toggleRow}>
          <Text style={styles.toggleLabel}>No alcohol</Text>
          <Switch
            value={dealBreakers.noDrinking}
            onValueChange={(v) => updateBreaker('noDrinking', v)}
            trackColor={{ false: '#555', true: '#53a8b6' }}
            thumbColor="#fff"
          />
        </View>
        ...
        <View style={styles.toggleRow}>
          <Text style={styles.toggleLabel}>No drugs</Text>
          <Switch
            value={dealBreakers.noDrugs}
            onValueChange={(v) => updateBreaker('noDrugs', v)}
            trackColor={{ false: '#555', true: '#53a8b6' }}
            thumbColor="#fff"
          />
        </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.toggleRow}>
          <Text style={styles.toggleLabel}>Must want kids</Text>
          <Switch
            value={dealBreakers.mustWantKids}
            onValueChange={(v) => {
              updateBreaker('mustWantKids', v);
              if (v) updateBreaker('mustNotWantKids', false);
            }}
            trackColor={{ false: '#555', true: '#53a8b6' }}
            thumbColor="#fff"
          />
        ...
        <View style={styles.toggleRow}>
          <Text style={styles.toggleLabel}>Must NOT want kids</Text>
          <Switch
            value={dealBreakers.mustNotWantKids}
            onValueChange={(v) => {
              updateBreaker('mustNotWantKids', v);
              if (v) updateBreaker('mustWantKids', false);
            }}
            trackColor={{ false: '#555', true: '#53a8b6' }}
            thumbColor="#fff"
          />
        ...
        <View style={styles.toggleRow}>
          <Text style={styles.toggleLabel}>Must already have kids</Text>
          <Switch
            value={dealBreakers.mustHaveKids}
            onValueChange={(v) => {
              updateBreaker('mustHaveKids', v);
              if (v) updateBreaker('mustNotHaveKids', false);
            }}
            trackColor={{ false: '#555', true: '#53a8b6' }}
            thumbColor="#fff"
          />
        ...
        <View style={styles.toggleRow}>
          <Text style={styles.toggleLabel}>Must NOT have kids</Text>
          <Switch
            value={dealBreakers.mustNotHaveKids}
            onValueChange={(v) => {
              updateBreaker('mustNotHaveKids', v);
              if (v) updateBreaker('mustHaveKids', false);
            }}
            trackColor={{ false: '#555', true: '#53a8b6' }}
            thumbColor="#fff"
          />
      ...
      <View style={styles.section}>
        ...
        <View style={styles.toggleRow}>
          <Text style={styles.toggleLabel}>Same religion only</Text>
          <Switch
            value={dealBreakers.sameReligionOnly}
            onValueChange={(v) => {
              updateBreaker('sameReligionOnly', v);
              if (v) updateBreaker('requiredReligion', null);
            }}
            trackColor={{ false: '#555', true: '#53a8b6' }}
            thumbColor="#fff"
          />
          ...
          {RELIGIONS.map((religion) => (
            <TouchableOpacity
              ...
              style={[
                ...
                dealBreakers.requiredReligion === religion && styles.religionButtonActive,
              ]}
              onPress={() => {
                updateBreaker('requiredReligion', 
                  dealBreakers.requiredReligion === religion ? null : religion
                );
                updateBreaker('sameReligionOnly', false);
              }}
            >
              <Text style={[
                styles.religionButtonText,
                dealBreakers.requiredReligion === religion && styles.religionButtonTextActive,
              ]}>
                {religion}
              </Text>
            </TouchableOpacity>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.distanceRow}>
          <TextInput
            ...
            placeholderTextColor="#666"
            value={dealBreakers.maxDistanceKm?.toString() || ''}
            onChangeText={(t) => updateBreaker('maxDistanceKm', t ? parseInt(t) : null)}
            keyboardType="number-pad"
            maxLength={4}
          />
      ...
      >
        <Text style={styles.saveButtonText}>
          {saving ? 'Saving...' : '✓ Save Deal Breakers'}
        </Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity
        ...
        onPress={() => setDealBreakers(DEFAULT_DEAL_BREAKERS)}
      >
