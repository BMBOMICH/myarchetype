    ...
    return [
      {
        ...
        render: () => (
          <View style={styles.header}>
            ...
            <Text style={styles.title} accessibilityRole="header">📊 Your Dating Stats</Text>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.infoCard}>
              <View style={styles.infoRow} accessibilityLabel={`Average rating: ${stats.averageRating}`}>
                ...
                <Text style={[styles.infoValue, styles.goldText]}>{stats.averageRating} ⭐</Text>
              </View>
              ...
              {stats.secondDateRate > 0 && (
                <View style={styles.infoRow} accessibilityLabel={`Second date rate: ${stats.secondDateRate} percent`}>
                  ...
                  <Text style={[styles.infoValue, styles.greenText]}>{stats.secondDateRate}%</Text>
                </View>
              )}
            </View>
          </View>
        ...
        render: () => (
          <View style={styles.tipsCard}>
            ...
            {stats.matchRate >= 30 && stats.conversationRate >= 60 && (
              <Text style={styles.tipText}>✅ You're doing great! Keep being yourself and stay active.</Text>
            )}
          </View>
        ),
      },
